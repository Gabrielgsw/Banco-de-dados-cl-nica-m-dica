...
-- tabela paciente
insert into paciente values('012.345.678-90','Gabriel Germano','(81)91234-5678',123456,'Inovamed','Padrão');
insert into paciente values('123.456.789-12','Thiago Henrique','(81)92345-6789',234567,'Ultramed','Básico');
insert into paciente values('234.567.890-23','Rinaldo Lourenço','(81)94567-8901',345678,'Inovamed','Especial');
insert into paciente values('345.678.901-45','Anthony Gabriel','(81)95678-9012',456789,'Ultramed','Padrão');
insert into paciente values('456.789.012-34','Gabriel Bezerra','(81)96789-0123',567890,'Inovamed','Especial');
insert into paciente values('334.769.543.65','Aécio José','(81)96621-7642',745269,'Inovamed','Básico');
...
select * from paciente;
update paciente set nome_paciente = 'Luís Carvalho' where cpf = '456.789.012-34';
select * from paciente;
